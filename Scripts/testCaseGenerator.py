...
if __name__ == "__main__":
    ...
    for i in range(1000000):
        ...
        # f1.write("ffffffff" + temp1 + "\n")
        # f2.write("ffffffff" + temp2 + "\n")
        # expected_sum.write("ffffffff" + temp4 + "\n")
        # expected_diff.write("ffffffff" + temp5 + "\n")
        # expected_product.write("ffffffff" + temp3 + "\n")
        # expected_quotient.write("ffffffff" + temp6 + "\n")
